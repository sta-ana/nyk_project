...
use App\Http\Livewire\User\studentfile;
...
// });
    ...
    Route::get('/user/studentfile', Studentfile::class)->name('user.studentfile');
    ...
    //for csv fileupload
    Route::Post('importCSV', [StudentList::class], 'test');
    Route::get('importCSV', [StudentList::class], 'importCSV');
