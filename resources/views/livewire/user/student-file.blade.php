<div wire:key="studentFileUpload_{{ $selectedStudentId }}">
    <div class="row text-start">
        ...
        <div class="col">
            ...
            <button wire:click="uploadPsa" class="btn btn-primary btn-sm mt-2">Upload</button>
            ...
            <button wire:click="uploadForm137" class="btn btn-primary btn-sm mt-2">Upload</button>
        </div>
    </div>
